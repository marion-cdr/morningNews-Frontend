...
import { removeAllHideArticle } from '../reducers/hiddenArticles';
...
function Header() {
	...
	const handleRegister = () => {
		fetch('https://morning-news-backend-mocha.vercel.app/users/signup', {
			method: 'POST',
	...
	const handleConnection = () => {
		...
		fetch('https://morning-news-backend-mocha.vercel.app/users/signin', {
			method: 'POST',
			headers: { 'Content-Type': 'application/json' },
	...
	const handleHideBackClick = () => {
		dispatch(removeAllHideArticle());
	}
	...
	return (
		<header className={styles.header}>
			<div className={styles.logoContainer}>
				...
				{userSection}
				<div >
				<FontAwesomeIcon onClick={() => handleHideBackClick()} icon={faEye} />
				</div>
			</div>
